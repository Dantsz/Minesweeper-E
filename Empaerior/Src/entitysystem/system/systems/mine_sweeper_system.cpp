...
void Mine_sweep_system::OnDeath()
{
	//death control
	if (Empaerior::Game::touched_mine)
	{
		Empaerior::Game::touched_mine = false;
		delete Empaerior::Game::first_state;
		Empaerior::Game::first_state = new State();
		Empaerior::Game::cur_state = Empaerior::Game::first_state;
	}
}
